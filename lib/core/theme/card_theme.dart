...
class CardDecoration {
  ...
  static BoxDecoration standard({
    ...
    return BoxDecoration(
      ...
      boxShadow: [
        // Single subtle shadow - reduced intensity
        BoxShadow(
  ...
  /// Raised card with medium shadow - between Standard and Elevated
  static BoxDecoration raised({
    ...
    return BoxDecoration(
      ...
      borderRadius: borderRadius ?? BorderRadius.circular(16),
      border: Border.all(
        color: borderColor ?? colors.borderBase.withValues(alpha: 0.45),
        width: 1.5,
      ),
      boxShadow: [
        // Medium shadow - between Standard and Elevated
        BoxShadow(
